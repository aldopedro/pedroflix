  ...
  const [emailExist, setEmailExist] = useState(Boolean)
    ...
    return (
      <div>
        ...
        <div className={emailExist ? style.displayNone : style.displayAuto}>
          <div className={style.mainAlert}>
            <div className={style.emailExist}>
              ...
              <div><strong>Parece que essa conta já existe.</strong><Link className={style.loginAlert} href="/login"> Acesse essa conta</Link> ou tente usar outro email.</div>
            </div>
          </div>
        </div>
        ...
        <RegistrationFooter language='pt' languageStep="formEN" />
      </div>
    )
  }
